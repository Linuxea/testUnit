...
/**
 * copy from https://www.liaoxuefeng.com/article/001373878023676e3047b48d1684f92ba10826baff4c436000
 */
public class ClassPathScanner {
    ...
    public static void main(String[] args) {
        List<Class<?>> list = new ClassPathScanner(
                "algorithm.easy",clazz -> clazz.isAssignableFrom(Object.class)).scan();
